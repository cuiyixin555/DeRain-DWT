...
parser.add_argument("--save_path", type=str, default='./logs/RainLight/AID_location135/', help='path of log files')
parser.add_argument("--save_freq", type=int, default=1, help='save intermediate model')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/SoftWare1/DerainDataset/Heavy_Light/train/rain_data_train_Light/', help='path to training data')
