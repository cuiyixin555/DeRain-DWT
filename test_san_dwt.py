...
from utils import *
from module.generator_san135 import BRN, print_network
import time

parser = argparse.ArgumentParser(description="AID_DWT_Test")
parser.add_argument("--logdir", type=str, default='./logs/DWT/Rain200H_san_120/')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Rain200H/test/small/rain/')
parser.add_argument("--save_path", type=str, default='./results/DWT/Rain200H_SAN/')
parser.add_argument('--save_path_r', type=str, default='./results/DWT/Rain200H_SAN/streak/')
