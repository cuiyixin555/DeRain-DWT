...
import pytorch_ssim
from module.generator_aff135 import BRN
from DWT import *
...
parser.add_argument("--save_path", type=str, default='./logs/DWT/Rain200H_aff_100/')
...
if __name__ == "__main__":
    if opt.preprocess:
        prepare_data_Rain200H(data_path=opt.data_path, patch_size=120, stride=100)
    main()
