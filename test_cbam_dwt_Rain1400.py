...
parser.add_argument("--logdir", type=str, default='/media/ubuntu/Seagate/PRICAI/DWT-Net/logs/DWT/Rain1400_cbam_100/')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Rain1400/test/small/rain/')
parser.add_argument("--save_path", type=str, default='./results/DWT/Rain1400_CBAM_100/')
parser.add_argument('--save_path_r', type=str, default='./results/DWT/Rain1400_CBAM_100/streak/')
