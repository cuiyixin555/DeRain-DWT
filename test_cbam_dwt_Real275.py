...
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Real/test/small/rain/')
parser.add_argument("--save_path", type=str, default='/media/ubuntu/Seagate/PRICAI/DWT-Net/results/DWT/Rain275_CBAM_100/')
parser.add_argument('--save_path_r', type=str, default='/media/ubuntu/Seagate/PRICAI/DWT-Net/results/DWT/Rain275_CBAM_100/streak/')
