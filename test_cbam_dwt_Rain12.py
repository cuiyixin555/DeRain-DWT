...
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Rain12/test/test/small/rain/')
parser.add_argument("--save_path", type=str, default='./results/DWT/Rain12_CBAM_100/')
parser.add_argument('--save_path_r', type=str, default='./results/DWT/Rain12_CBAM_100/streak/')
