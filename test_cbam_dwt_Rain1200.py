...
parser.add_argument("--logdir", type=str, default='/media/ubuntu/Seagate/PRICAI/DWT-Net/logs/DWT/Rain1200_cbam_100_new/')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Rain1200/test/small/rain/')
parser.add_argument("--save_path", type=str, default='./results/DWT/Rain1200_CBAM_100/')
parser.add_argument('--save_path_r', type=str, default='./results/DWT/Rain1200_CBAM_100/streak/')
