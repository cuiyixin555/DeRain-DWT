...
parser.add_argument("--save_path", type=str, default='./logs/DWT/Rain1400_cbam_100')
parser.add_argument("--save_freq", type=int, default=1, help='save intermediate model')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Rain1400/train/small/')
