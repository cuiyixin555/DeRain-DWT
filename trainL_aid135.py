...
parser.add_argument("--save_path", type=str, default="logs/Rain100L/AID_location135/", help='path of log files')
parser.add_argument("--save_freq", type=int, default=1, help='save intermediate model')
parser.add_argument("--data_path", type=str, default='/media/r/cyx/RainDataset/Train_H_L/train/RainTrainL/', help='path to training data')
