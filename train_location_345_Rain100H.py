...
import pytorch_ssim
from networks.generator_aid345 import BRN
...
parser.add_argument("--save_path", type=str, default='./logs/Rain100H/location_TrainH_345/', help='path of log files')
parser.add_argument("--save_freq", type=int, default=1, help='save intermediate model')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/SoftWare1/DerainDataset/RainTrainH/', help='path to training data')
