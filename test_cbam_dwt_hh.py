...
parser.add_argument("--logdir", type=str, default='./logs/Ablation/hh/')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Real/test/small/rain/')
parser.add_argument("--save_path", type=str, default='./results/Ablation/real_hh/')
parser.add_argument('--save_path_r', type=str, default='./results/Ablation/real_hh/streak/')
