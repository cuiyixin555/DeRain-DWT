...
parser.add_argument("--logdir", type=str, default='/media/ubuntu/Seagate/PRICAI2022/DWT-Net/weight/CBAM/Rain200H/')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/SPA/test/small/rain/')
parser.add_argument("--save_path", type=str, default='./results/DWT/SPA_CBAM_100_after/')
parser.add_argument('--save_path_r', type=str, default='./results/DWT/SPA_CBAM_100_after/streak/')
