...
parser.add_argument("--logdir", type=str, default='/media/ubuntu/Seagate/PRICAI/DWT-Net/logs/Ablation/r5/')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Rain200H/test/small/rain/')
parser.add_argument("--save_path", type=str, default='/media/ubuntu/Seagate/PRICAI/DWT-Net/logs/Ablation/res_r5/')
parser.add_argument('--save_path_r', type=str, default='/media/ubuntu/Seagate/PRICAI/DWT-Net/logs/Ablation/res_r5/streak/')
parser.add_argument("--use_GPU", type=bool, default=True, help='use GPU or not')
parser.add_argument("--gpu_id", type=str, default='1', help='GPU id')
parser.add_argument("--inter_iter", type=int, default=5, help='number of inter_iteration')
