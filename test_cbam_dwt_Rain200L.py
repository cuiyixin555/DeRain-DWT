...
parser.add_argument("--logdir", type=str, default='./logs/DWT/Rain200L_cbam_100/')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Rain200L/test/small/rain/')
parser.add_argument("--save_path", type=str, default='./results/DWT/Rain200L_CBAM_100/')
parser.add_argument('--save_path_r', type=str, default='./results/DWT/Rain200L_CBAM_100/streak/')
...
def main():
    ...
    if opt.use_GPU:
        model = model.cuda()
    state_dict = torch.load(os.path.join(opt.logdir, 'net_epoch45.pth'))
