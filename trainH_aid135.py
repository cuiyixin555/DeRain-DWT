...
parser = argparse.ArgumentParser(description="AID")
...
parser.add_argument("--save_path", type=str, default='logs/Rain100H/AID_location135/', help='path of log files')
parser.add_argument("--save_freq", type=int, default=1, help='save intermediate model')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/SoftWare1/DerainDataset/Train_H_L/train/RainTrainH/', help='path to training data')
...
def main():
    ...
    # Build model
    mu = 1.0
    net = BRN(recurrent_iter=opt.inter_iter, beta=mu, use_GPU=opt.use_GPU)
    ...
    for epoch in range(initial_epoch, opt.epochs):
        ...
        for i, (input, target) in enumerate(loader_train, 0):
            ...
            with torch.no_grad():
                ...
                save_image(epoch, [out_train, target_train, out_r_train], opt.res_path)
