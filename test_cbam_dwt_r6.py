...
parser.add_argument("--logdir", type=str, default='/media/ubuntu/Seagate/PRICAI2022/DWT-Net/logs/Ablation/r6/')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Rain200H/test/small/rain/')
parser.add_argument("--save_path", type=str, default='/media/ubuntu/Seagate/PRICAI2022/DWT-Net/logs/Ablation/res_r6/')
parser.add_argument('--save_path_r', type=str, default='/media/ubuntu/Seagate/PRICAI2022/DWT-Net/logs/Ablation/res_r6/streak/')
parser.add_argument("--use_GPU", type=bool, default=True, help='use GPU or not')
parser.add_argument("--gpu_id", type=str, default='0,1', help='GPU id')
parser.add_argument("--inter_iter", type=int, default=6, help='number of inter_iteration')
