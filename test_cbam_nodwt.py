...
parser = argparse.ArgumentParser(description="AID_NoDWT_Test")
parser.add_argument("--logdir", type=str, default='./logs/Ablation/nodwt/')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/SPA/test/small/rain/')
parser.add_argument("--save_path", type=str, default='./results/Ablation/spa_nodwt/')
parser.add_argument('--save_path_r', type=str, default='./results/Ablation/spa_nodwt/streak/')
