...
from utils import *
from module.generator_calibrate135 import BRN, print_network
import time

parser = argparse.ArgumentParser(description="AID_DWT_Test")
parser.add_argument("--logdir", type=str, default='./logs/DWT/Rain200H_calibrate_100/')
parser.add_argument("--data_path", type=str, default='/media/ubuntu/Seagate/RainData/Rain200H/test/small/rain/')
parser.add_argument("--save_path", type=str, default='./results/DWT/Rain200H_Calibrate/')
parser.add_argument('--save_path_r', type=str, default='./results/DWT/Rain200H_Calibrate/streak/')
